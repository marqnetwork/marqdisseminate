...
;(function(window) {
	...
	CircleSlideshow.prototype._init = function() {
		...
		this.navLeftCtrl.innerHTML = '<svg width="100px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none" stroke="#FFCC00" stroke-width="5" points="69.821,3.795 92.232,26.205 0,26.205"/></svg>';
		...
		this.navRightCtrl.innerHTML = '<svg width="100px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none" stroke="#FFCC00" stroke-width="5" points="30.179,26.205 7.768,3.795 100,3.795"/></svg>';
...
// if( dir === 'right' ) {
// var test = $('.slide--current').next().find('#product_main_title').text();
// 					var testcon = $('.slide--current #product_main_title');
//   					testcon.shuffleLetters({
// 				        "text": test
// 				    });
// 				    console.log(test);
// } 
...
// $('.arkadena').html('');
// var oka = $(nextEl).prev().prev().prev().text();
// var okacon = $(nextEl).prev().html('<h1>'+ oka +'</h1>');

// 		okacon.shuffleLetters({
//         "text": oka
//     });
//     console.log(oka);
$('div.product_main_title').css('display', 'none').css('width', '0px').css('height', '0px');
$('div.pixiefy-animated-text').css('display', 'block');
$('div.pixiefy-animated-text').html('');
var oka = $(nextEl).prev().prev().prev().text();
var okacon = $('div.pixiefy-animated-text').html(oka);
...
// 				var oka = $(nextEl).prev().prev().text();
// 				var okacon = $(nextEl).prev().prev();
// 				$(okacon).css('opacity', 1);
